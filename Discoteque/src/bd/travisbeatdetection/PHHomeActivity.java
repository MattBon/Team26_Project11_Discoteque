 ...
 * 
 * @link https://github.com/PhilipsHue/PhilipsHueSDK-Java-MultiPlatform-Android
 *
 */
public class PHHomeActivity extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phHueSDK.setAppName("Discoteque");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.find_new_bridge) {
			doBridgeSearch();
		}
        return true;
    }
    ...
    public void startMainActivity() {   
        Intent intent = new Intent(getApplicationContext(), HomeDiscotequeActivity.class);
